...
PRD Section 7 kill criterion #4 triggers if avg cost over rolling 24h exceeds $0.05 at production scale — kill Story surface, ship deterministic-only emails.
