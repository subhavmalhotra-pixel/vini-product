...
// ─────────────────────────────────────────────────────────────────────────────
// Scope filters — department, agent, channel direction (IB/OB)
// ─────────────────────────────────────────────────────────────────────────────
export type Department = "all" | "sales" | "service";
export type Direction = "all" | "ib" | "ob";
export type ScopeMode = "department" | "agent";

export type MockAgent = {
  id: string;
  name: string;
  department: Exclude<Department, "all">;
  direction: Exclude<Direction, "all">; // IB or OB specialization
};

export const MOCK_AGENTS: MockAgent[] = [
  { id: "ag-001", name: "Marcus Chen",      department: "sales",   direction: "ib" },
  { id: "ag-002", name: "Priya Shah",       department: "sales",   direction: "ib" },
  { id: "ag-003", name: "Diego Alvarez",    department: "sales",   direction: "ob" },
  { id: "ag-004", name: "Hannah Brooks",    department: "sales",   direction: "ob" },
  { id: "ag-005", name: "Jordan Patel",     department: "service", direction: "ib" },
  { id: "ag-006", name: "Sofia Ramirez",    department: "service", direction: "ib" },
  { id: "ag-007", name: "Liam O'Donnell",   department: "service", direction: "ob" },
  { id: "ag-008", name: "Emma Tanaka",      department: "service", direction: "ob" },
];

// Which email types support the IB/OB direction selector.
export const DIRECTION_APPLIES_TO: Record<string, boolean> = {
  daily: false,
  weekly: true,
  monthly: true,
  eoc: false,
