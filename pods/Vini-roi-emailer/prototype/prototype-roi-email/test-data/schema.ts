...
export type EmailType = "daily" | "weekly" | "monthly" | "eoc";
...
export interface EOCData {
  ...
  conversion_by_vehicle_or_service: Array<{
    name: string;
    conversion_pct: number;
    appts: number;
  }>;

  recommendations: string[]; // 2-4 bullet recommendations
