  ...
  agent_kpi_strips: [
    {
      agent: "sales_ob",
      cards: [
        { label: "Customers reached", primary_value: 412, delta: 8.2, delta_label: "WoW" },
        { label: "Connected", primary_value: 158, delta: 12.4, delta_label: "WoW" },
        { label: "Appts", primary_value: 22, delta: -3.5, delta_label: "WoW" },
        { label: "Cost / Appt", primary_value: "$41.20", delta: -2.1, delta_label: "WoW" },
      ],
    },
  ],
  day_by_day_trend: [
  ...
  agent_kpi_strips: [
    {
      agent: "sales_ib",
      cards: [
        { label: "Inbound leads", primary_value: 287, delta: 4.7, delta_label: "WoW" },
        { label: "Appts set", primary_value: 94, delta: 11.3, delta_label: "WoW" },
        { label: "Avg first-contact", primary_value: "48s", delta: -6.8, delta_label: "WoW" },
        { label: "Warm transfers", primary_value: 41, delta: 5.0, delta_label: "WoW" },
      ],
    },
  ],
  day_by_day_trend: [
...
export const WEEKLY_SERVICE_IB_ONLY: WeeklyData = {
  ...
  agent_kpi_strips: [
    {
      // v2 "Week at glance" — Total calls / Appointment intent / Appointments / ABR%
      agent: "service_ib",
      cards: [
        { label: "Total calls", primary_value: 218, delta: 2.1, delta_label: "WoW" },
        ...
        { label: "ABR", primary_value: "57%", delta: 3.2, delta_label: "WoW" },
      ],
    },
  ],
  ...
  agent_kpi_strips: [
    {
      agent: "service_ob",
      cards: [
        { label: "Customers reached", primary_value: 198, delta: -4.2, delta_label: "WoW" },
        { label: "Connected", primary_value: 78, delta: 1.4, delta_label: "WoW" },
        { label: "Appts", primary_value: 14, delta: 16.7, delta_label: "WoW" },
        { label: "Cost / Appt", primary_value: "$28.40", delta: -8.9, delta_label: "WoW" },
      ],
    },
  ],
  day_by_day_trend: [
