    ...
    >
      ...
      <section className="px-4 py-6 sm:px-6 sm:py-8 lg:px-10">
        ...
        <div className="mt-3 grid grid-cols-2 gap-3 sm:grid-cols-4">
          <FunnelStat label="Unique" value={data.funnel.unique} />
          <FunnelStat label="Engaged" value={data.funnel.engaged} />
          <FunnelStat label="Converted" value={data.funnel.converted} accent />
          <FunnelStat
            label="Avg touches · channels"
            value={`${data.funnel.avg_touches} · ${data.funnel.avg_channels}`}
          />
        </div>
        <div className="mt-4 text-xs leading-relaxed text-text-secondary">
          <span className="font-semibold tabular text-text-primary">
            {data.funnel.new_vs_returning.new}%
          </span>{" "}
          new ·{" "}
          <span className="font-semibold tabular text-text-primary">
            {data.funnel.new_vs_returning.returning}%
          </span>{" "}
...
function FunnelStat({
  ...
  return (
    <div className="rounded-lg border border-border-subtle bg-surface-background p-4">
      ...
      <div
        className={`mt-2 text-2xl font-bold leading-tight tabular sm:text-3xl ${
